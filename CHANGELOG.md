...
## [7.0.0](https://github.com/input-output-hk/cardano-graphql/compare/6.2.0...7.0.0) (2022-08-15)

### Compatible with:

- [`cardano-node`: `1.35.3`](https://github.com/input-output-hk/cardano-node/releases/tag/1.35.3)
- [`cardano-ogmios`: `v5.5.3`](https://github.com/CardanoSolutions/ogmios/releases/tag/v5.5.3)
...
* update to Ogmios v5.5.0 cardano-db-sync 13.0.0
